      ...
      <div
        ...
        <form @submit.prevent="handleAddProduct">
          ...
          <div style="margin-bottom: 20px;">
            ...
            <input v-model="productData.name" type="text" id="name" class="form-control"
          ...
          <div style="margin-bottom: 20px;">
            ...
            <textarea v-model="productData.description" id="description" class="form-control"
              style="width:100%; padding:10px; border: 1px solid #c4ab9f;" rows="5"></textarea>
          ...
          <div style="margin-bottom: 20px;">
            ...
            <input v-model="productData.price" type="number" id="price" class="form-control"
              style="width:100%; padding:10px; border: 1px solid #c4ab9f;" />
          ...
          <div style="margin-bottom: 20px;">
            ...
            <div style="display: flex; align-items: center; gap: 10px;">
              ...
              <button @click="$router.push('/add-category')" type="button" title="Add Category"
